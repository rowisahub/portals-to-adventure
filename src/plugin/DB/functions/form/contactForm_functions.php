...
class contactForm_functions
{
  ...
  public function __construct(db_handler $handler_instance = null, db_functions $db_functions = null)
  {
    ...
    $this->table_path = $this->handler_instance->get_table_path('form_contact');

    $this->logger = new Log('Contact Form Functions');
    $this->logger = $this->logger->getLogger();
  }

  public function add_completed_form($form_id, $user_id, $email, $name, $message, $subject = null)
  {
    $uuid = $this->db_functions->generate_uuid('form_contact');
  ...
  public function get_form_contact($form_id = null, $user_id = null)
  {
